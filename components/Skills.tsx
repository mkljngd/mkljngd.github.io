  ...
  return (
    <section id="skills" className="section-padding">
      <div className="container-custom">
            ...
            return (
              ...
              >
                <div className="flex items-center mb-4 sm:mb-6">
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-text-primary">{category.title}</h3>
                </div>
        ...
        >
          <h3 className="text-3xl font-bold mb-8 text-text-primary">Key Achievements</h3>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              ...
              >
                <h4 className="font-semibold text-text-primary mb-3">{stack.name}</h4>
                <div className="space-y-2">
                  {stack.techs.map((tech, techIndex) => (
                    <motion.div
                      ...
                      className="flex items-center space-x-2 py-2 px-3 rounded-lg bg-background-dark/20 hover:bg-background-dark/30 transition-colors duration-300 group"
                    >
                      ...
                      <span className="text-sm text-text-secondary group-hover:text-text-primary transition-colors duration-300">{tech}</span>
                    </motion.div>
                  ))}
                </div>
              </motion.div>
